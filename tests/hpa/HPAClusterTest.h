...
class HPAClusterTest : public CPPUNIT_NS::TestFixture
{
	CPPUNIT_TEST_SUITE( HPAClusterTest );
		...
		CPPUNIT_TEST( buildDiagonalEntrancesShouldCreateAnEntranceBetweenTwoDiagonallyAdjacentClustersIfALowLevelEdgeAlreadyConnectsThem );
	...
	public:
		...
		void buildDiagonalEntrancesShouldCreateAnEntranceBetweenTwoDiagonallyAdjacentClustersIfALowLevelEdgeAlreadyConnectsThem();
