...
class AnnotatedClusterTest : public CPPUNIT_NS::TestFixture
{
	...
	CPPUNIT_TEST( connectEntranceEndpointsShouldCalculateTheSmallestSetOfShortestPathsBetweenEachPairOfParentNodesGivenALowOrMediumQualityAbstraction );
	...
	public:
		...
		void connectEntranceEndpointsShouldCalculateTheSmallestSetOfShortestPathsBetweenEachPairOfParentNodesGivenALowOrMediumQualityAbstraction();
