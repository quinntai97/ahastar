...
class AnnotatedClusterTest : public CPPUNIT_NS::TestFixture
{
	...
	CPPUNIT_TEST( buildVerticalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInLeftClusterWhileDepthInRightClusterRemainsConstant );
	CPPUNIT_TEST( buildVerticalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInRightClusterWhileDepthInLeftClusterRemainsConstant );
	CPPUNIT_TEST( buildVerticalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInBothLeftAndRightClustersSimultaneously );
	...
	CPPUNIT_TEST( buildHorizontalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInTopClusterWhileDepthInBottomClusterRemainsConstant );
	CPPUNIT_TEST( buildHorizontalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInBottomClusterWhileDepthInTopClusterRemainsConstant );
	CPPUNIT_TEST( buildHorizontalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInBothTopAndBottomClustersSimultaneously );
	...
	public:
		...
		void buildVerticalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInLeftClusterWhileDepthInRightClusterRemainsConstant();
		void buildVerticalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInRightClusterWhileDepthInLeftClusterRemainsConstant();
		void buildVerticalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInBothLeftAndRightClustersSimultaneously();
		...
		void buildHorizontalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInTopClusterWhileDepthInBottomClusterRemainsConstant();
		void buildHorizontalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInBottomClusterWhileDepthInTopClusterRemainsConstant();
		void buildHorizontalEntrancesShouldStopExpandingTheEntranceWhenDepthValueIncreasesOrDecreasesInBothTopAndBottomClustersSimultaneously();
