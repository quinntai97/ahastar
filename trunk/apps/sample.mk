...
$(sample_OBJS)  : %.o : %.cpp $(DRIVER_SRC:.cpp=.h) $(OPTHPA_SRC:.cpp=.h) $(HPASTAR_SRC:.cpp=.h) $(AHASTAR_SRC:.cpp=.h) $(SHARED_SRC:.cpp=.h) $(UTIL_SRC:.cpp=.h) $(SIMULATION_SRC:.cpp=.h) $(RTS_OBJS:.o=.h)
