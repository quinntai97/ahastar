...
a diagonal move. 
Note that we use the function $d$ to refer to actual distance between two nodes.
...
\end{definition}
\par \noindent
Note that $h$ is a heuristic function that returns either 
straight-line distance or octile distance between two nodes on a grid.
