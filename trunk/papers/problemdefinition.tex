...
% DH: maybe prefer the shorter definition below?
%An agent can move a single step at a time in any of the four cardinal directions provided its displacement after each timestep is not greater than than the length or width of a single octile.
