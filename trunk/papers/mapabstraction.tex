...
As per \cite{botea04}, our final step to complete the decomposition involves attempting to connect each pair of abstract nodes identified in each cluster. 
