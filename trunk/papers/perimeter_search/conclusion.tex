...
that RSR can be up to five times faster than two recent state-of-the-art search
space reduction techniques.
\par
We demonstrate that RSR is not only more generally applicable than the algorithm
of \citeauthor{harabor10}~\shortcite{harabor10} (on which it is based) but also
...
of \citeauthor{pochter10}~\shortcite{pochter10}.  We show that the two
