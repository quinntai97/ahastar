...
%
%
%Notice that no direct comparison between these methods has been available previously.
%In previous work, the authors measured their improvements only in comparison
%with A* on the original, non-abstracted maps.
%
