...
\begin{figure}[htbp]
	\vspace{-15pt}
	\caption{\small{\emph{HAA* performance (HQ vs LQ abstraction)}}}
	\begin{center}
...
\begin{figure}[htbp]
	\vspace{-12pt}
	\caption{\small{\emph{HAA* total search effort (nodes expanded).}}}
	\begin{center}
...
The average time required to compute a solution was observed to have very similar trends to those shown in Figure \ref{aha-fig:searcheffort}; on this particular dataset HAA* averaged 6.3ms and 3.7ms using HQ and LQ graphs respectively.
