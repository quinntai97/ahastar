...
To further complicate things a number of dead-end rooms exist containing tiles with \emph{f-values} smaller
than the the goal and these must also be expanded.
...
In order to solve the problem more efficiently we will divide the map into a set of obstacle-free rooms and 
