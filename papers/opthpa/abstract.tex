...
and prunes all interior but not perimeter nodes,
eliminating symmetric paths from the interior of each room.
...
On our test data, A* can run up to 4 times faster on average.
