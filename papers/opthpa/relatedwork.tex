...
It can be seen as an online technique for detecting areas that don't have to be searched
...
Our empty room decomposition bears some similarity with the HPA* algorithm \cite{botea04},
