...
Figure \ref{aha-fig:clustersandentrances} demonstrates this idea; the highlighted region represents the entrance area and the connected tiles the transition point.
We use a similar approach but require as a parameter $C$, the set of all capabilities, and attempt to identify entrances $\forall c \in C$. 
\begin{figure}[htbp]
	\vspace{-20pt}
